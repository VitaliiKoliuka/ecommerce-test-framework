...
import random
from api.schemas.cart_schema import Cart
from api.schemas.cart_product_schema import CartProduct
from api.schemas.login_schema import Login
...
class Payload:
    ...
    def login_payload(self, config):
        return {
            "username": config.get_property("username"),
            "password": config.get_property("password")
        }
